...
# Title: Top Block
# Generated: Wed Jan 19 21:26:54 2022
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.sps_TX = sps_TX = 16
        self.sps_RX = sps_RX = 4
        self.nfilts = nfilts = 32
        self.EBW = EBW = 350e-3
        self.samp_rate = samp_rate = 76.8e3*20*1.3
        ...
        self.rational_resampler_xxx_1 = filter.rational_resampler_ccc(
                interpolation=1,
                decimation=int(sps_TX/sps_RX)/4,
                taps=None,
                fractional_bw=None,
        )
        ...
        self._qtgui_sink_x_1_0_0_win = sip.wrapinstance(self.qtgui_sink_x_1_0_0.pyqwidget(), Qt.QWidget)
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.qtgui_sink_x_1_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_1_0_0.set_frequency_range(0, self.samp_rate/10)
