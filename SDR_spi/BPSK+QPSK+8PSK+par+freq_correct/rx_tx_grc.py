...
# Title: Rx Tx Grc
# Generated: Tue Feb  1 13:01:13 2022
##################################################
...
class rx_tx_grc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/artiom/~Shared/SDR_system-main/SDR_spi/tx_data', True)
