...
# Title: Rx Tx Grc
# Generated: Sat Jan 22 17:37:00 2022
##################################################
...
class rx_tx_grc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/ar/shared/konf/SDR_spi/BPSK+QPSK+8PSK+par+freq_correct/rx_tx_grc.py', True)
