...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._delay_range = Range(0, 400, 1, 86, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._SNR_range = Range(0, 30, 0.01, 30, 200)
        self._SNR_win = RangeWidget(self._SNR_range, self.set_SNR, 'SNR[dB]', "counter_slider", float)
        self.top_grid_layout.addWidget(self._SNR_win, 18, 0, 1, 1)
        ...
        self.qtgui_number_sink_0_0_0_0.set_update_time(0.05)
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_0_0_0_0_win, 22, 0, 1, 1)
        ...
        self.qtgui_number_sink_0_0_0.set_update_time(0.05)
        self.qtgui_number_sink_0_0_0.set_title("Power_noise")
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_0_0_0_win, 20, 0, 1, 1)
        ...
        self.qtgui_number_sink_0_0.set_update_time(0.05)
        self.qtgui_number_sink_0_0.set_title("Power_signal")
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_0_0_win, 19, 0, 1, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 17, 0, 1, 1)
        ...
        self.blocks_multiply_const_xx_1 = blocks.multiply_const_ff(10, 1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(1.3)
        self.blocks_moving_average_xx_1_0 = blocks.moving_average_ff(76800*20, 0.000013021/20, 76800*20, 1)
        self.blocks_moving_average_xx_1 = blocks.moving_average_ff(76800*20, 0.000013021/20, 76800*20, 1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/artiom/Shared/SDR_system-main/SDR_analis/data.txt', True, 0, 0)
        ...
        self.connect((self.blocks_complex_to_mag_squared_1, 0), (self.blocks_moving_average_xx_1, 0))
        self.connect((self.blocks_complex_to_mag_squared_1_0, 0), (self.blocks_moving_average_xx_1_0, 0))
        ...
        self.connect((self.blocks_moving_average_xx_1, 0), (self.blocks_divide_xx_0, 0))
        self.connect((self.blocks_moving_average_xx_1, 0), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.blocks_moving_average_xx_1_0, 0), (self.blocks_divide_xx_0, 1))
        self.connect((self.blocks_moving_average_xx_1_0, 0), (self.qtgui_number_sink_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_const_sink_x_1, 0))
        self.connect((self.blocks_multiply_const_xx_1, 0), (self.qtgui_number_sink_0_0_0_0, 0))
        ...
        self.connect((self.blocks_throttle_1, 0), (self.channels_channel_model_0_1_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_char_to_float_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_pack_k_bits_bb_0_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_stream_to_vector_0_0_0, 0))
        ...
        self.connect((self.channels_channel_model_0_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.channels_channel_model_0_1, 0), (self.qtgui_sink_x_1_0, 0))
        self.connect((self.channels_channel_model_0_1, 0), (self.rational_resampler_xxx_1, 0))
        self.connect((self.channels_channel_model_0_1_0, 0), (self.blocks_complex_to_mag_squared_1_0, 0))
        self.connect((self.channels_channel_model_0_1_0, 0), (self.qtgui_freq_sink_x_0, 2))
        ...
        self.connect((self.digital_constellation_modulator_0, 0), (self.blocks_complex_to_mag_squared_1, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.channels_channel_model_0_1, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.qtgui_freq_sink_x_0, 1))
    ...
    def set_time_offset_0(self, time_offset_0):
        ...
        self.channels_channel_model_0_0.set_timing_offset(self.time_offset_0)
        self.channels_channel_model_0_1.set_timing_offset(self.time_offset_0)
        self.channels_channel_model_0_1_0.set_timing_offset(self.time_offset_0)
    ...
    def set_noise_volt_0(self, noise_volt_0):
        ...
        self.channels_channel_model_0_0.set_noise_voltage(self.noise_volt_0)
    ...
    def set_freq_offset_0(self, freq_offset_0):
        ...
        self.channels_channel_model_0_0.set_frequency_offset(self.freq_offset_0)
        self.channels_channel_model_0_1.set_frequency_offset(self.freq_offset_0)
        self.channels_channel_model_0_1_0.set_frequency_offset(self.freq_offset_0)
    ...
    def set_SNR(self, SNR):
        self.SNR = SNR
        self.channels_channel_model_0_1.set_noise_voltage(1/(10**(self.SNR/20)))
        self.channels_channel_model_0_1_0.set_noise_voltage(1/(10**(self.SNR/20)))
